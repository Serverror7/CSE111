...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        element = periodic_table_dict[i[0]]
        element_mass = element[ATOMIC_MASS_INDEX]
        mass = mass + element_mass * i[1]
...
def main():
    ...
    elem_dict = parse_formula(formula, periodic_table_dict)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(elem_dict, periodic_table_dict)
