...
def test_get_prepositional_phrase():
    ...
    test_get_verb()
    # This ensures a prepositional phrase (which is just an assembly of the previous functions) is whole and complete by checking the previous functions. If one function is broken, so is this.
    pass
